...
class Simulation:
    def __init__(self, u_init_fn: str, base_dir: str, exec_cmd: str, init_params: dict, param_fn: str, u0_fn: str,
                 pert_var: str, grow_var: str, derived_fields: callable = None):
        """
        ...
        :param derived_fields: The function to compute derived fields from the yt dataset, usually to compute grow_var
        """
