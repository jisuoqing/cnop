...
class Simulation:
    def __init__(self, u_init_fn: str, base_dir: str,
                 ...
                 wrapper_finish_check_fn: str, exec_finish_check_poll_interval: float,
        ...
        :param exec_finish_check_poll_interval: The interval to check whether the simulation output stops changing
        ...
        if self.restart:
            ...
            self.exec_finish_check_poll_interval = exec_finish_check_poll_interval
    ...
    def run_simulation_with_python_wrapper(self, exec_cmd: str, wrapper_nproc: int, wrapper_args: str = None,
                                           exec_finish_check_fn: str = None,
                                           exec_finish_check_poll_interval: float = None):
        generate_python_wrapper(exec_cmd, wrapper_path=self.base_dir)
        # Now start the simulation
        current_dir = os.getcwd()
        os.chdir(self.base_dir)
        new_comm = self.mpi_comm_self.Spawn(command='python3', args=["wrapper.py"] + wrapper_args.split(),
                                            maxprocs=wrapper_nproc)
    ...
    def proceed_simulation(self, params, t1,
                           ...
                           wrapper_finish_check_fn=None,
                           exec_finish_check_poll_interval=None,
        ...
        if wrapper_finish_check_fn is not None:
            # if a different finish check file is needed for restarting
            self.wrapper_finish_check_fn = wrapper_finish_check_fn
        if exec_finish_check_poll_interval is not None:
            # if a different finish check interval is needed for restarting
            self.exec_finish_check_poll_interval = exec_finish_check_poll_interval
