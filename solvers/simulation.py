...
class Simulation:
    def __init__(self, u_init_fn: str, base_dir: str,
                 exec_command: str, wrapper_args: str, wrapper_nproc: int, wrapper_finish_check_fn: str,
    ...
    def run_simulation_with_python_wrapper(self, exec_cmd: str, wrapper_nproc: int, wrapper_args: str = None,
        ...
        if not wait_for_file("stdout.txt", timeout=10, poll_interval=5.):
            raise RuntimeError("The simulation is not running!")
        if exec_finish_check_fn is None:
            # make sure the final output file is generated
            if not wait_for_file(exec_finish_check_fn, timeout=10, poll_interval=5.):
    ...
    def proceed_simulation(self, params, t1,
                           exec_command=None, wrapper_args=None, wrapper_nproc=None, wrapper_finish_check_fn=None,
